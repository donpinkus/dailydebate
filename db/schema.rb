...
ActiveRecord::Schema.define(version: 20141027185211) do
  ...
  create_table "agree_votes", force: true do |t|
    t.integer  "user_id"
    t.integer  "topic_id"
    t.boolean  "is_agree"
    t.datetime "created_at"
  ...
  add_index "agree_votes", ["topic_id"], name: "index_agree_votes_on_topic_id"
  add_index "agree_votes", ["user_id"], name: "index_agree_votes_on_user_id"
